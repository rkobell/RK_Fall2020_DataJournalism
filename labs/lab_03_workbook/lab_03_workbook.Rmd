...
covid_county_jun_aug_pct_change <- covid_county_monthly_case_rate %>%
  ...
  filter(state == "Maryland") %>%
  mutate(jun_aug_pct_change = (d_2020_08_30 - d_2020_06_30)/d_2020_06_30) %>%
  arrange(desc(jun_aug_pct_change))

covid_county_jun_aug_pct_change
# Garrett County
```
...
arrange(may_aug_pct_change)

covid_county_may_aug_pct_change
# Jones County
```
