...
# group by how it was disposed of (disposition)
# pivot to names
# mutate to closed_by_arrest and closed_without_arrest
...
# filter for the years 2014 and 2017
#group by city, year, and deposition
#count
# mutate to replace N/A with 0
#mutate to create new columns for closed by arresr, closed w/o arrest and open no arrest
...
# take your new date frameof cities_arrest_rate and make a new one for cities_arrest_less
#filter the percent change
#ungroup to get a three-city arrest rate
#count those arrests.
