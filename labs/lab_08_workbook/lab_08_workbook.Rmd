...
# It lists states but it doesn't give you more than that.Long column names.
...
# Long column names, a blank row, missing data, character columns that should be nummeric; messy data.
```
...
opioid_scrape_clean <- opioid_scrape %>%
  ...
  # Add an additional function here as instructed (done - see above)
