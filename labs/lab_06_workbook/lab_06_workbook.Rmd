...
```{r}
pills_per_person <- county_pills_population %>%
  mutate(pills_per_person = average_pills_per_year/population) %>%
...
pills_per_person
```
# Put the answer here Norton City, Va.
